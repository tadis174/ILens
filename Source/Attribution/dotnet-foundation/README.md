...
- Source URL: https://raw.githubusercontent.com/dotnet/runtime/v8.0.26/LICENSE.TXT
- Vendored from: dotnet/runtime, tag `v8.0.26`

The pinned tag matches the runtime version this build bundles. The LICENSE
file does not change between 8.0.x patch versions in practice; using the
